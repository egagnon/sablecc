...
class ConcatOperation {
    ...
    private Map<Pair<State, Set<Pair<State, State>>>, State> stateMap = new HashMap<>();

    private SortedMap<State, Pair<State, Set<Pair<State, State>>>> progressMap = new TreeMap<>();
    ...
    ConcatOperation(
        ...
        Pair<State, Set<Pair<State, State>>> progress = new Pair<>(
    ...
    private void addTransition(
        ...
        if (rightTargetProgress.size() > 0) {
            Pair<State, Set<Pair<State, State>>> targetProgress = new Pair<>(
