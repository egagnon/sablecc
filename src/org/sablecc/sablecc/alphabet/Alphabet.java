...
public class Alphabet {
    ...
    private void init(
        ...
        this.symbols = Collections
                .unmodifiableSortedSet(new TreeSet<>(symbols));
    ...
    public AlphabetMergeResult mergeWith(
        ...
        Map<Pair<Symbol, Symbol>, SortedSet<Interval>> symbolPairToIntervalSetMap = Alphabet
        ...
        SortedMap<Symbol, SortedSet<Symbol>> alphabetSymbolMap = new TreeMap<>();
    ...
    private static Map<Pair<Symbol, Symbol>, SortedSet<Interval>> computeSymbolPairToIntervalSetMap(
        ...
        Map<Pair<Symbol, Symbol>, SortedSet<Interval>> symbolPairToIntervalSetMap = new LinkedHashMap<>();
