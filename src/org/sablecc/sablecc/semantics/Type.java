    ...
    Type(
        ...
        elementBody.apply(new TreeWalker() {
            ...
            public void caseACharUnit(
                ...
                Expression expression = grammar
                        .getExpressionResolution(node.getChar());
            ...
            public void caseAStringUnit(
                ...
                Expression expression = grammar
                        .getExpressionResolution(node.getString());
            ...
            public void caseAEndUnit(
                ...
                Expression expression = grammar
                        .getExpressionResolution(node.getEndKeyword());
            ...
            public void caseAIntervalManyOperator(
                ...
                Type.this.minMultiplicity = new BigInteger(
                        node.getFrom().getText());
                Type.this.maxMultiplicity = new BigInteger(
                        node.getTo().getText());
                Type.this.isList = true;
