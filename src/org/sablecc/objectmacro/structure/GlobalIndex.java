...
public class GlobalIndex {
    ...
    private final Map<Set<Macro>, ExpandSignature> expandSignatureMap = new HashMap<>();
    ...
    public void computeIndirectlyReferencedTextBlocks() {
        ...
        ComponentFinder<Scope> componentFinder = new ComponentFinder<>(scopes,
                referencedTextBlockProgeny);
